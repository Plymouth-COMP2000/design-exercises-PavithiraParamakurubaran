...
public class StaffBaseActivity extends AppCompatActivity {

    protected static final String CHANNEL_ID = "notifications_channel";

    protected BottomNavigationView staffbottomNav;
    ...
    protected void setupBottomNavigation(final int currentMenuId) {
        staffbottomNav = findViewById(R.id.staffbottomNav);
        if (staffbottomNav == null) return;

        staffbottomNav.setSelectedItemId(currentMenuId);

        staffbottomNav.setOnItemSelectedListener(item -> {
            int id = item.getItemId();
            if (id == currentMenuId) return true;

            if (id == R.id.nav_home) {
                openActivity(StaffHomeActivity.class);
            } else if (id == R.id.nav_menu) {
                openActivity(StaffMenuActivity.class);
            } else if (id == R.id.nav_reservation_request) {
                openActivity(StaffReservationRequestActivity.class);
            } else if (id == R.id.nav_reservations) {
                openActivity(StaffReservation.class);
            } else if (id == R.id.nav_settings) {
                openActivity(StaffSettingsActivity.class);
            }
            ...
            if (headerView != null) {
                ...
                if (logoutLayout != null) {
                    logoutLayout.setOnClickListener(v -> {
                        ...
                        Intent intent = new Intent(StaffBaseActivity.this, SelectAuthActivity.class);
